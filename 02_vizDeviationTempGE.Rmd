...
```{r teaser heatmap, eval = T}
  ...
  png("output/geneva_1753_2017_tiles_walllpaper_mb.png", width = 414, height = 900, res = 1000)
  print(tiles_bare_mb)
  dev.off()
  
  png("output/geneva_1753_2017_tiles_walllpaper_dk.png", width = 1536, height = 800, res = 1000)
  print(tiles_bare_dk)
  dev.off()
